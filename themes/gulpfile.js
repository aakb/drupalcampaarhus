...
var argv = require('yargs')
  ...
  .alias('d', 'domain')
  .default('sync', false)
  .default('theme', ['drupalcampaarhus_theme'])
  .default('domain', 'drupalcampaarhus_theme.vm')
  .argv;
...
var gulp = require('gulp-help')(require('gulp'), {
  'afterPrintCallback' : function() {
    ...
    console.log(chalk.cyan('  *') + chalk.green(' gulp watch --theme base --theme blue --domain test.drupalcampaarhus_theme.vm --sync'));
...
var configuration = {
  // Base theme.
  'drupalcampaarhus_theme': {
    "js": {
      "paths": ['./drupalcampaarhus_theme/js/*.js', '!./drupalcampaarhus_theme/js/*.min.*'],
      "dest": './drupalcampaarhus_theme/js'
    },
    "sass": {
      "paths": './drupalcampaarhus_theme/scss/**/*.scss',
      'dest': './drupalcampaarhus_theme/css'
    },
    "twig": {
      "paths": './drupalcampaarhus_theme/templates/**/*.twig'
    }
  }
};
